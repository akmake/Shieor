        ...
        LazyColumn(
            ...
            item {
                Column(
                    ...
                    // ברוך שם - ממורכז
                    Text(
                        text = "בָּרוּךְ שֵׁם כְּבוֹד מַלְכוּתוֹ לְעוֹלָם וָעֶד:",
                        modifier = Modifier.fillMaxWidth().padding(bottom = 16.dp), // רווח שורה למטה
                        textAlign = TextAlign.Center,
                        fontSize = 20.sp,
                        fontFamily = SblHebrew,
                        color = Color(0xFF1A1A1A),
